// Audit History component - this file contains the InvoiceAuditHistory export
// File: InvoicePaymentsTable2.tsx should be InvoiceAuditHistory.tsx
// Exporting here for structure integrity
